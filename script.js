...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const logos = marqueeContent.innerHTML;

  // Duplicar el contenido de logos para crear un scroll infinito sin saltos
  marqueeContent.innerHTML += logos + logos; // Agregamos el contenido dos veces más para hacer que el scroll sea continuo.
});